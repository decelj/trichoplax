...
public:
    ...
    inline const glm::vec3& ll() const
    { return mBounds[0]; }
    inline const glm::vec3& ur() const
    { return mBounds[1]; }
    bool isValid() const;
    ...
    void update(const glm::vec3& ll, const glm::vec3& ur)
    { mBounds[0] = ll; mBounds[1] = ur; }
    void setLL(const glm::vec3& ll)
    { mBounds[0] = ll; }
    void setUR(const glm::vec3& ur)
    { mBounds[1] = ur; }
    ...
    inline float split(const unsigned axis) const
    {
